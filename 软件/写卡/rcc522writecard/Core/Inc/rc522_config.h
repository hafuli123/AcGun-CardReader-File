...
#define        macRC522_CS_RCC_CLK_ENABLE()             __HAL_RCC_GPIOA_CLK_ENABLE()	              	   
#define        macRC522_GPIO_CS_PORT    	              GPIOA
#define        macRC522_GPIO_CS_PIN		                  GPIO_PIN_4

#define        macRC522_SCK_RCC_CLK_ENABLE()            __HAL_RCC_GPIOA_CLK_ENABLE()	   
#define        macRC522_GPIO_SCK_PORT    	              GPIOA			   
#define        macRC522_GPIO_SCK_PIN		                GPIO_PIN_5

#define        macRC522_M0S_RCC_CLK_ENABLE()            __HAL_RCC_GPIOA_CLK_ENABLE()	   
...
#define        macRC522_RST_RCC_CLK_ENABLE()            __HAL_RCC_GPIOA_CLK_ENABLE()
